...
import com.lunartown.zzimcong.product.service.CartService;
...
public class CartController {
    ...
    @GetMapping
    public ResponseEntity<List<CartProductDto>> getMyCart(
            @AuthenticationPrincipal UserDetails userDetails) {
        // JWT에서 추출한 사용자 정보를 사용
        Long userId = Long.parseLong(userDetails.getUsername());
        List<CartProductDto> cart = cartService.getCartProductsForUser(userId);
